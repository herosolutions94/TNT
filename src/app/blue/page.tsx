  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <ScrollReveal>
            ...
            <h1 className="font-display font-black leading-tight mb-6 text-slate-900"
              ...
              Get Paid to<br />
              <span className="text-blue-600 animate-pulse">Go Viral.</span>
            </h1>
            ...
            <p className="max-w-xl mx-auto text-lg mb-10 text-slate-600 font-medium leading-relaxed">
              ...
              <span className="text-blue-700 font-bold">$2,000 per video</span>, and learn virality from influencers.
            </p>
      ...
      <section id="the-job" className="py-28 px-6 md:px-16 max-w-7xl mx-auto bg-white">
        <ScrollReveal>
          <p className="text-xs font-bold tracking-widest uppercase mb-4 text-blue-600">The Opportunity</p>
      ...
      <section id="referrals" className="py-28 px-6 md:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <p className="text-xs font-bold tracking-widest uppercase mb-4 text-blue-600">Testimonials</p>
